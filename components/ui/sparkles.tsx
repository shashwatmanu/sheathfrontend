...
export const SparklesCore = (props: ParticlesProps) => {
  ...
  // Memoize the particlesLoaded callback to prevent unnecessary re-renders
  ...
  // Memoize the options object to prevent the tsparticles engine from re-initializing on every render
