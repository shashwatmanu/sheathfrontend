...
export const SparklesCore = (props: ParticlesProps) => {
  ...
  // Memoize the particlesLoaded callback to prevent re-creation on every render
  ...
  // Memoize options to prevent unnecessary re-initializations of the tsparticles engine
