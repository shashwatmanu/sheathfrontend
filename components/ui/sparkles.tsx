...
export const SparklesCore = (props: ParticlesProps) => {
  ...
  // Optimized: Memoize the callback to prevent recreation on every render
  ...
  // Optimized: Memoize options to prevent unnecessary re-initialization of Particles engine
