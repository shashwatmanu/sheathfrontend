...
export const SparklesCore = (props: ParticlesProps) => {
  ...
  // Memoize the loaded callback to prevent re-creation on every render
  ...
  // Memoize the options object to avoid re-initializing the particle engine on every render
