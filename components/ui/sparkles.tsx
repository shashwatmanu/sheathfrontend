...
export const SparklesCore = (props: ParticlesProps) => {
  ...
  // Memoize the callback to prevent unnecessary re-renders of the Particles component
  ...
  // Memoize the options object to prevent expensive re-initializations of the particle engine on every render
