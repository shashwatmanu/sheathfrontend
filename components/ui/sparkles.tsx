...
export const SparklesCore = (props: ParticlesProps) => {
  ...
  // Optimized: Wrap particlesLoaded in useCallback to maintain referential identity
  ...
  // Optimized: Memoize options object to prevent unnecessary re-initializations
