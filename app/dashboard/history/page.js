...
export default function HistoryPage() {
    ...
    // Performance optimization: calculate aggregations in a single pass using useMemo and a for-loop.
    // Avoids redundant iterations across large arrays.
    const { totalAmountProcessed, uniquePatientsProcessed } = useMemo(() => {
        let amount = 0;
        let patients = 0;
